      ...
      return (
        <View style={styles.Deck}>
          ...
          <Text
            style={[
              styles.Title,
              { margin: 10, textAlign: "center", color: "red" },
            ]}
          >
            Sorry, There are no questions in this deck. Please add some
            questions before attempting a quiz.
          </Text>
          <TouchableOpacity
      ...
      return (
        <View style={styles.Deck}>
          ...
          <TouchableOpacity
            style={styles.Incorrect}
            onPress={() =>
              navigation.navigate("DeckDetails", { title, questions })
            }
          >
      ...
      <View style={styles.Deck}>
        ...
        <View style={styles.Question}>
          <Text style={styles.Number}>
            {this.state.showAnswer ? "Answer" : "Question"} {attempted + 1} of{" "}
            {questions.length}
          </Text>
          {this.state.showAnswer && (
            <Text style={styles.TextArea}>
              {questions[attempted]["answer"]}
            </Text>
          )}
          {!this.state.showAnswer && (
            <Text style={styles.TextArea}>
              {questions[attempted]["question"]}
            </Text>
          )}
        </View>
        <TouchableOpacity
